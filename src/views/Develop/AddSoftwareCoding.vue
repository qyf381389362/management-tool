/*
 * @Author: 秦雨霏 
 * @Date: 2018-05-10 12:34:57 
 * @Last Modified by: 秦雨霏
 * @Last Modified time: 2018-05-10 12:42:21
 */
  ...
  <el-container>
    <el-main class="wrapper">
      <el-breadcrumb class="breadcrumb">
        ...
        <el-breadcrumb-item :to="{path:'/home/develop/softwareStructure'}">软件编码</el-breadcrumb-item>
        <el-breadcrumb-item>添加软件编码</el-breadcrumb-item>
      </el-breadcrumb>
...
export default {
  ...
  methods: {
    onSubmit () {
      this.$router.push({name: 'SoftwareCoding'})
    },
    cancle () {
      this.$router.push({name: 'SoftwareCoding'})
    }
